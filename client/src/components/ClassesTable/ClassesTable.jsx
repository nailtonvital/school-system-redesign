                          ...
                          <table className="table-auto text-left overflow-x-scroll">
                              <thead className="bg-white border-b">
                                  <tr>
                                      ...
                                      <th scope="col" className="text-sm font-medium text-gray-900 px-6 py-4 text-left">Period</th>
                              ...
                              <tbody>
                                  <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                      ...
                                      <td className="text-sm text-gray-900 font-bold px-6 py-4 whitespace-nowrap">
                                          ...
                                          <button className='bg-green-600 hover:bg-green-500 p-1 rounded'>
                                            <svg className='fill-white' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M15 11h7v2h-7zm1 4h6v2h-6zm-2-8h8v2h-8zM4 19h10v-1c0-2.757-2.243-5-5-5H7c-2.757 0-5 2.243-5 5v1h2zm4-7c1.995 0 3.5-1.505 3.5-3.5S9.995 5 8 5 4.5 6.505 4.5 8.5 6.005 12 8 12z"></path></svg>
                                          </button>
                                          <button className='bg-blue-600 hover:bg-blue-500 p-1 rounded'>
                                          ...
                                          <button className='bg-red-600 hover:bg-red-500 p-1 rounded'>
