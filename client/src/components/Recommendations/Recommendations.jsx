...
export default function Recommendations() {
  return (
      <section class="mb-20 mt-5 text-gray-700 col-span-full">
          <h3 class="text-2xl font-bold mb-6 text-gray-800">Recommendations for you</h3>
          ...
          <div class="grid md:grid-cols-3 gap-6 lg:gap-12 text-center overflow-x-auto">
              <div class="mb-12 md:mb-0">
                  ...
                  <h6 class="font-semibold text-blue-600 -mt-5 mb-4">Web Developer</h6>
                  <p class="mb-4">
                      <svg
                          aria-hidden="true"
                          focusable="false"
              ...
              <div class="mb-12 md:mb-0">
                  ...
                  <h6 class="font-semibold text-blue-600 -mt-5 mb-4">Graphic Designer</h6>
                  <p class="mb-4">
                      <svg
                          aria-hidden="true"
                          focusable="false"
              ...
              <div class="mb-0">
                  ...
                  <h6 class="font-semibold text-blue-600 -mt-5  mb-4">Marketing Specialist</h6>
                  <p class="mb-4">
                      <svg
                          aria-hidden="true"
                          focusable="false"
